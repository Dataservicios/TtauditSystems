                    ...
                    .then((response) => {
                        ...
                        if ((type == 2) || (type == 3)) {
                            ...
                            for (var indice in response.data['opciones']) {
                                Acum = Acum + response.data['count'][indice];
                            }
                            for (var indice in response.data['opciones']) {
                                this.datos.push({opcion: response.data['opciones'][indice], valor: response.data['count'][indice],porcen: (response.data['count'][indice]/Acum)*100});
